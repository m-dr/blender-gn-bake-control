#!/usr/bin/env python3
"""
Build compliant Blender 5.2+ extension .zip package.
"""
import hashlib
import json
import os
...
EXCLUDE_DIRS = {"scripts", "dist", "build", ".git", "__pycache__", ".github", "tests"}
EXCLUDE_FILES = {"AGENTS.md", "README.md", ".gitignore", ".gitattributes"}
